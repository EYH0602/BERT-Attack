...
def attack(
    ...
    word_predictions = mlm_model(input_ids_.to(DEVICE))[
        0
...
def evaluate(features):
    ...
    print(
        "acc/aft-atk-acc {:.6f}/ {:.6f}, query-num {:.4f}, change-rate {:.4f}".format(
...
def run_attack():
    ...
    parser.add_argument(
        "--start", type=int, help="start step, for multi-thread process"
    )
